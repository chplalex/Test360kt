...
// работающий код. сохранил перед тем, как вносить правку для возможности отката к исходному состоянию
class ShooterActivity_save : AppCompatActivity() {

    companion object {
        fun start(context: Context) =
            Intent(context, ShooterActivity_save::class.java).apply {
    ...
    private fun onCreateSub() {
        ...
        txtLensName = TextView(this).apply {
            ...
            setOnClickListener {
                ...
                val intent = Intent(this@ShooterActivity_save, LensesActivity::class.java).apply {
        ...
        imgRotMode?.setOnClickListener {
            ...
            val progress = ProgressDialog(this@ShooterActivity_save).apply {
                if (isSDKRotator) {
    ...
    override fun onResume() {
        ...
        mDMDCapture?.apply {
            ...
            startCamera(this@ShooterActivity_save, mWidth, mHeight)
...
//            },0, 16);
        ...
        override fun onFinishRelease() {
            ...
            mDMDCapture!!.startCamera(this@ShooterActivity_save, mWidth, mHeight)
        }
...
//            Log.e("AMS", "percentage:" + map.get(DMD_Capture.ShootingIndicatorsEnum.percentage.toString()));//Double
        ...
        override fun compassEvent(info: HashMap<String, Any>) {
            Toast.makeText(this@ShooterActivity_save, "Compass interference", Toast.LENGTH_SHORT).show()
            mIsShootingStarted = false
        }
